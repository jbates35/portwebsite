...
fileToggle(1, '#fileDelButton1_id', '#fileUndoButton1_id', '#file1OccDiv_id', '#file1UpDiv_id');
fileToggle(2, '#fileDelButton2_id', '#fileUndoButton2_id', '#file2OccDiv_id', '#file2UpDiv_id');
fileToggle(3, '#fileDelButton3_id', '#fileUndoButton3_id', '#file3OccDiv_id', '#file3UpDiv_id');
...
imageToggle(1, '#childDelButton1_id', '#childUndoButton1_id', '#childOverlayDiv1_id', '#childImgBox1_id');
imageToggle(2, '#childDelButton2_id', '#childUndoButton2_id', '#childOverlayDiv2_id', '#childImgBox2_id');
imageToggle(3, '#childDelButton3_id', '#childUndoButton3_id', '#childOverlayDiv3_id', '#childImgBox3_id');
imageToggle(4, '#childDelButton4_id', '#childUndoButton4_id', '#childOverlayDiv4_id', '#childImgBox4_id');
imageToggle(5, '#childDelButton5_id', '#childUndoButton5_id', '#childOverlayDiv5_id', '#childImgBox5_id');
imageToggle(6, '#childDelButton6_id', '#childUndoButton6_id', '#childOverlayDiv6_id', '#childImgBox6_id');
