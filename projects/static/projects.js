	...
	<div class="box-1">
		<div class="img-box-1">
			<div class="img-click" onclick="changeProject(`+id_i+`); popupProject();">
				...
				<div class="title-1">`+title+` <span class="titleyear">(`+date.substring(0,4)+`)<span></div>
			</div>
		</div>
	</div>
	`);
...
function projectDisplay(date, description, title, ylink, creator, planguage, id, olink1, olink2, olink3, olinkdesc1, olinkdesc2, olinkdesc3, imgfilesuploaded, imgdesc_1, imgdesc_2, imgdesc_3, imgdesc_4, imgdesc_5, imgdesc_6, filecount) {
