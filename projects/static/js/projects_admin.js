  ...
  $("#mainListingCont_id").append(
	...
	<div class="box-1">
      ...
      `)<span></div>
			...
			<div class="edit-box">
				<button class="eButton" onclick="editProj(` +
      id +
      `)">Edit</button>|<button class="eButton" onclick="deleteProj(` +
      id +
      `)">Delete</button>
			</div>
		</div>
...
function projectDisplay(
  ...
  //actual function:
  $("#projContTitle_id").html(
    title +
      ` (` +
      date.substring(0, 4) +
      `) <button class="eButton_proj" onclick="editProj(` +
      id +
      `)">Edit</button>|<button class="eButton_proj" onclick="deleteProj(` +
      id +
      `)">Delete</button>`,
  ); //Title
